...
export function Free_Laptop() {
  return (
    <svg fill="#000" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
...
export function Busy_Laptop() {
  return (
    <svg fill="red" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
